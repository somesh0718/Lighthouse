...
export class HMIssueReportingService {
    ...
    getHMIssueReportingById(hmIssueReportingId: string) {
        return this.http
            .HttpGet(this.http.Services.HMIssueReporting.GetById + '?hmIssueReportingId=' + hmIssueReportingId)
            .pipe(
                retry(this.http.Services.RetryServieNo),
                catchError(this.http.HandleError),
                tap((response: any) => {
    ...
    createOrUpdateHMIssueReportingBulk(pageData) {
            ...
            this.api.selectTableData(pageData.uploadTable).then((list: any) => {
                if (list.length > 0) {
                    ...
                    for (const iterator of list) {
                        obsList.push(this.http.post(this.http.Services.BaseUrl + this.http.Services.HMIssueReporting.CreateOrUpdate,
    ...
    getAndLoadHMIssueReporting(obj) {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.localStorage.get('currentUser').then((cU) => {
                ...
                this.httpCli
                    .post(this.http.Services.BaseUrl + this.http.Services.HMIssueReporting.GetAllByCriteria, formData, options)
                    .subscribe(
                        (data: any) => {
                            if (data.Success) {
    ...
    getHMIssueReportingFromFormGroup(formGroup: FormGroup): HMIssueReportingModel {
        const issueReportingModel = new HMIssueReportingModel();
