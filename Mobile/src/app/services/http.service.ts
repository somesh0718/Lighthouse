...
export class HttpService extends HttpClient {
    ...
    constructor(public httpHandler: HttpHandler, private localStorage: Storage, options?: any,
    ...
    catchAuthError(self: HttpService) {
        ...
        return (response: Response) => {
            if (response.status === 401 || response.status === 403) {
                ...
                this.localStorage.remove(AppConstants.UserLocalStorage);
                this.localStorage.remove(AppConstants.AccessTokenLocalStorage);
