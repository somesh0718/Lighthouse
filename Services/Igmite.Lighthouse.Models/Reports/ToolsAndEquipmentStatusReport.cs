...
{
    [DataContract]
    public class ToolsAndEquipmentStatusReport
    {
        // Primary key
        [Key, DataMember]
        ...
        [DataMember]
        public virtual string ToolsAvailabilityStatus { get; set; }

        [DataMember]
        public virtual string ToolsReceiptStatus { get; set; }

        [DataMember]
        public virtual string MonthOfReceipt { get; set; }
