...
namespace Igmite.Lighthouse.Entities
{
    ...
    [Table("VTRCommunityHomeVisits")]
    public partial class VTRCommunityHomeVisit : BaseEntityCreation
    {
        public VTRCommunityHomeVisit()
        {
        }
        ...
        // Primary key
        [Key, DataMember]
        [Column("VTRCommunityHomeVisitId", TypeName = "UNIQUEIDENTIFIER", Order = 1)]
        [Display(Name = "VTRCommunity Home Visit Id", Description = "VTRCommunity Home Visit Id", Order = 1)]
        [Required(ErrorMessage = EntityConstants.RequiredErrorMessage)]
        public virtual Guid VTRCommunityHomeVisitId { get; set; }
        ...
        [DataMember]
        [Column("CommunityVisitDetails", Order = 5)]
        [Display(Name = "Community Visit Details", Description = "Community Visit Details", Order = 5)]
