...
namespace Igmite.Lighthouse.Entities
{
    ...
    [Table("VTIssueReporting")]
    public partial class VTIssueReporting : BaseEntity
    {
        ...
        // Primary key
        [Key, DataMember]
        [Column("VTIssueReportingId", TypeName = "UNIQUEIDENTIFIER")]
        [Display(Name = "VTIssue Reporting Id", Description = "VTIssue Reporting Id")]
