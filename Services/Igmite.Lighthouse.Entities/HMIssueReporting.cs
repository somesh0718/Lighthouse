...
namespace Igmite.Lighthouse.Entities
{
    ...
    [Table("HMIssueReporting")]
    public partial class HMIssueReporting : BaseEntity
    {
        ...
        // Primary key
        [Key, DataMember]
        [Column("HMIssueReportingId", TypeName = "UNIQUEIDENTIFIER")]
        [Display(Name = "HMIssue Reporting Id", Description = "HMIssue Reporting Id")]
