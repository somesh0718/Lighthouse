...
namespace Igmite.Lighthouse.Entities
{
    ...
    [Table("StudentsForExitForm")]
    public partial class StudentsForExitForm : BaseEntity
    {
        public StudentsForExitForm()
        {
        }

        // Primary key
        [Key, DataMember]
        [Column("ExitStudentId", TypeName = "UNIQUEIDENTIFIER", Order = 1)]
