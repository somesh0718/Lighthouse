...
namespace Igmite.Lighthouse.Entities
{
    ...
    [Table("DRPDailyReporting")]
    public partial class DRPDailyReporting : BaseEntity
    {
        ...
        // Primary key
        [Key, DataMember]
        [Column("DRPDailyReportingId", TypeName = "UNIQUEIDENTIFIER")]
        [Display(Name = "DRPDaily Reporting Id", Description = "DRPDaily Reporting Id")]
        [Required(ErrorMessage = EntityConstants.RequiredErrorMessage)]
        public virtual Guid DRPDailyReportingId { get; set; }

        // Foreign key
        [DataMember]
        [Column("DRPId", TypeName = "UNIQUEIDENTIFIER")]
        [Display(Name = "DRPId", Description = "DRPId")]
        public virtual Guid DRPId { get; set; }
