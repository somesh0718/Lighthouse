...
namespace Igmite.Lighthouse.DAL
{
    ...
    /// </summary>
    public interface IReportRepository : IGenericRepository<DataType>
    {
        /// <summary>
        ...
        /// <returns></returns>
        VTAttendanceHeaderModel GetVTAttendanceHeaderForPDF(string userId, Guid vtId, DateTime reportDate);
        ...
        /// <param name="reportDate"></param>
        /// <returns></returns>
        IList<VTAttendanceDetailModel> GetVTAttendanceDetailForPDF(string userId, Guid vtId, DateTime reportDate);
        ...
        /// <param name="reportDate"></param>
        /// <returns></returns>
        VCAttendanceHeaderModel GetVCAttendanceHeaderForPDF(string userId, Guid vcId, DateTime reportDate);
        ...
        /// <param name="reportDate"></param>
        /// <returns></returns>
        IList<VCAttendanceDetailModel> GetVCAttendanceDetailForPDF(string userId, Guid vcId, DateTime reportDate);
